...
public class HexBlockStatesAndModels extends PaucalBlockStateAndModelProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        var akashicRecordModel =
                models().withExistingParent("akashic_record", "block/block")
                                ...
                                for (int i = 1; i <= 4; i++) {
                                    var model =
                                            models().withExistingParent(
                                                            "akashic_bookshelf_" + i,
                                                            modLoc("block/akashic_bookshelf"))
                                                    .texture(
                                                            "overlay",
                                                            modLoc(
                                                                    "block/akashic_bookshelf_overlay_"
                                                                            + i));
        ...
        blockAndItem(
                ...
                models().cubeAll(
                                "block/deco/slate_bricks_small",
                                modLoc("block/deco/slate_bricks_small")));
        ...
        blockAndItem(
                ...
                models().cubeAll(
                                "block/deco/amethyst_bricks",
                                modLoc("block/deco/amethyst_bricks")));
        blockAndItem(
                HexBlocks.AMETHYST_BRICKS_SMALL,
                models().cubeAll(
                                "block/deco/amethyst_bricks_small",
                                modLoc("block/deco/amethyst_bricks_small")));
        directionalBlock(
        ...
        blockAndItem(
                ...
                models().cubeAll(
                                "block/deco/slate_amethyst_tiles",
                                modLoc("block/deco/slate_amethyst_tiles")));
        ...
        blockAndItem(
                ...
                models().cubeAll("edified_panel", modLoc("block/edified_panel")));
        blockAndItem(
                HexBlocks.EDIFIED_TILE,
                models().cubeAll("edified_tile", modLoc("block/edified_tile")));
        ...
        simpleBlock(
                ...
                ConfiguredModel.builder()
                        ...
                        .modelFile(
                                models().cubeAll(
                                                "edified_planks_2",
                                                modLoc("block/edified_planks_2")))
                        .weight(3)
                        .nextModel()
                        .modelFile(
                                models().cubeAll(
                                                "edified_planks_3",
                                                modLoc("block/edified_planks_3")))
                        .build());
        ...
        simpleBlock(
                ...
                models().cubeAll(
                                ...
                                modLoc("block/deco/quenched_allay_tiles_0")));
        simpleBlock(
                HexBlocks.QUENCHED_ALLAY_BRICKS,
                models().cubeAll(
                                "quenched_allay_bricks",
                                modLoc("block/deco/quenched_allay_bricks_0")));
        simpleBlock(
                HexBlocks.QUENCHED_ALLAY_BRICKS_SMALL,
                models().cubeAll(
                                "quenched_allay_bricks_small",
                                modLoc("block/deco/quenched_allay_bricks_small_0")));
    }
        ...
        getVariantBuilder(block)
                .forAllStates(
                        bs -> {
                            ...
                            var modelName =
                                    "block/circle/" + name + "/" + litness + "_" + dir.getName();
                            var model =
                                    models().cube(
                                                    modelName,
                                                    modLoc(bottom),
                            ...
                            // Most blocks point north in the inv, but we have these point east so
                            // that their faces aren't obscured
                            // by the count number
        ...
        getVariantBuilder(HexBlocks.DIRECTRIX_REDSTONE)
                .forAllStates(
                        bs -> {
                            ...
                            // The front face can never be both lit and unpowered (b/c otherwise it
                            // would exit the other way)
                            ...
                            if (isLit && !isPowered && dir == Direction.EAST) {
                                // getBuilder does not add the block/etc to the front if the path
