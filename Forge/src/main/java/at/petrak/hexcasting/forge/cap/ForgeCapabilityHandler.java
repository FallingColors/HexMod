...
public class ForgeCapabilityHandler {
    ...
    public static void attachItemCaps(AttachCapabilitiesEvent<ItemStack> evt) {
        ...
        if (stack.getItem() instanceof MediaHolderItem holder) {
            evt.addCapability(
                    ...
                    provide(
                            ...
                            () -> new CapItemMediaHolder(holder, stack)));
        ...
        if (stack.getItem() instanceof IotaHolderItem holder) {
            evt.addCapability(
                    ...
                    provide(
                            ...
                            () -> new CapItemIotaHolder(holder, stack)));
            ...
            evt.addCapability(
                    ...
                    provide(
                            ...
                            HexCapabilities.IOTA,
                            () ->
                                    new CapStaticIotaHolder(
                                            (s) -> new DoubleIota(Math.PI * s.getCount()), stack)));
        }
        ...
        if (stack.getItem() instanceof HexHolderItem holder) {
            evt.addCapability(
                    ...
                    provide(
                            stack,
                            HexCapabilities.STORED_HEX,
                            () -> new CapItemHexHolder(holder, stack)));
        }
        ...
        if (stack.getItem() instanceof PigmentItem pigment) {
            evt.addCapability(
                    ...
                    provide(
                            stack,
                            HexCapabilities.COLOR,
                            () -> new CapItemPigment(pigment, stack)));
        }
    ...
    public static void attachEntityCaps(AttachCapabilitiesEvent<Entity> evt) {
        ...
        if (entity instanceof ItemEntity item) {
            ...
            evt.addCapability(
                    IOTA_STORAGE_CAP,
                    wrapItemEntityDelegate(
                            scroll, ItemDelegatingEntityIotaHolder.ToWallScroll::new));
