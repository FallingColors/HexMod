...
public class HexplatRecipes extends PaucalRecipeProvider {
    ...
    private final Map<BlockAkashicLog, BlockAkashicLog> EDIFIED_LOG_TO_WOOD =
            Map.ofEntries(
                    ...
                    //        Map.entry(HexBlocks.EDIFIED_LOG_AMETHYST,
                    // HexBlocks.EDIFIED_WOOD_AMETHYST),
                    //        Map.entry(HexBlocks.EDIFIED_LOG_AVENTURINE,
                    // HexBlocks.EDIFIED_WOOD_AVENTURINE),
                    //        Map.entry(HexBlocks.EDIFIED_LOG_CITRINE,
                    // HexBlocks.EDIFIED_WOOD_CITRINE),
                    //        Map.entry(HexBlocks.EDIFIED_LOG_PURPLE,
                    // HexBlocks.EDIFIED_WOOD_PURPLE),
    ...
    public void buildRecipes(Consumer<FinishedRecipe> recipes) {
        ...
        ShapelessRecipeBuilder.shapeless(
                        ...
                        (int) (MediaConstants.QUENCHED_SHARD_UNIT / MediaConstants.CRYSTAL_UNIT)
                                + 1)
                .requires(HexItems.QUENCHED_SHARD)
        ...
        ShapelessRecipeBuilder.shapeless(
                        RecipeCategory.BUILDING_BLOCKS, HexBlocks.EDIFIED_PLANKS, 4)
