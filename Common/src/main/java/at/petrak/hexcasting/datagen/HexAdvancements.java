...
public class HexAdvancements extends PaucalAdvancementSubProvider {
    public static final OvercastTrigger.Instance ENLIGHTEN =
            new OvercastTrigger.Instance(
                    ...
                    // TODO this means if 80% of your health is less than half a heart, so if you
                    // have 2.5 hearts or
    ...
    public void generate(HolderLookup.Provider provider, Consumer<Advancement> consumer) {
                ...
                Advancement.Builder.advancement()
                        ...
                        .display(
                                new DisplayInfo(
                                        ...
                                        true,
                                        true))
                        // the only thing making this vaguely tolerable is the knowledge the json
                        // files are worse somehow
                        .addCriterion(
                                "has_charged_amethyst",
                                InventoryChangeTrigger.TriggerInstance.hasItems(
                                        ItemPredicate.Builder.item()
                                                .of(HexTags.Items.GRANTS_ROOT_ADVANCEMENT)
                                                .build()))
                ...
                .display(
                        new DisplayInfo(
                                ...
                                Component.translatable(
                                        "advancement.hexcasting:creative_unlocker.desc"),
        ...
        Advancement.Builder.advancement()
                .display(
                        simpleDisplay(
                                Items.GLISTERING_MELON_SLICE, "wasteful_cast", FrameType.TASK))
                .parent(root)
                .addCriterion(
                        "waste_amt",
        ...
        var impotence =
                Advancement.Builder.advancement()
                        .display(
                                simpleDisplay(
                                        Items.BLAZE_POWDER, "y_u_no_cast_angy", FrameType.TASK))
                        .parent(root)
                        .addCriterion(
                                "did_the_thing",
        ...
        for (var advId : ItemLoreFragment.NAMES) {
            Advancement.Builder.advancement()
                    ...
                    .parent(loreRoot)
                    .addCriterion(
                            ItemLoreFragment.CRITEREON_KEY, new ImpossibleTrigger.TriggerInstance())
