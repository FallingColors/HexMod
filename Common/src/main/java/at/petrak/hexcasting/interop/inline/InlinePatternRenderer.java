...
public class InlinePatternRenderer implements InlineRenderer<InlinePatternData> {
    ...
    public static final PatternSettings INLINE_SETTINGS_GLOWY =
            new PatternSettings(
                    ...
                    new PatternSettings.StrokeSettings(
                            1, 3, 0.8 * 1 * 2.0 / 5.0, 0.4 * 1 * 2.0 / 5.0),
    ...
    public int render(
        ...
        PatternRenderer.renderPattern(
                data.pattern,
                drawContext.pose(),
                new PatternRenderer.WorldlyBits(
                        drawContext.bufferSource(), trContext.light(), null),
    ...
    public int charWidth(InlinePatternData data, Style style, int codepoint) {
        ...
        HexPatternPoints staticPoints =
                HexPatternPoints.getStaticPoints(
                        HexPatternLike.of(data.pattern), INLINE_SETTINGS, 0);
