...
public class PatchouliUtils {
    ...
    /**
     * Combines the ingredients, returning the first matching stack of each, then the second stack
     * of each, etc. looping back ingredients that run out of matched stacks, until the ingredients
     * reach the length of the longest ingredient in the recipe set.
     *
