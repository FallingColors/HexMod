...
public record PatternColors(int innerStartColor, int innerEndColor, int outerStartColor, int outerEndColor,
    ...
    public static final PatternColors SLATE_WOBBLY_COLOR = glowyStroke( 0xff_64c8ff);
    public static final PatternColors SLATE_WOBBLY_PURPLE_COLOR = glowyStroke(0xff_cfa0f3);
