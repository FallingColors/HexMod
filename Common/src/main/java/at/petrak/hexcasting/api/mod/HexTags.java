...
public class HexTags {
    public static final class Items {
        ...
        public static final TagKey<Item> GRANTS_ROOT_ADVANCEMENT =
                create("grants_root_advancement");
    ...
    public static final class Actions {
        /**
         * Actions with this tag can't be used until the caster is enlightened and send the "am I
         * not skilled enough" message
         */
        ...
        public static final TagKey<ActionRegistryEntry> PER_WORLD_PATTERN =
                create("per_world_pattern");
        ...
        public static TagKey<ActionRegistryEntry> create(String name) {
            return TagKey.create(
                    IXplatAbstractions.INSTANCE.getActionRegistry().key(), modLoc(name));
        }
    }
}
