...
public class EntityIota extends Iota {
    ...
    Tag serialize() {
        ...
        out.putString("name", Component.Serializer.toJson(getEntityNameWithInline(), RegistryAccess.EMPTY));
        return out;
    }

    @Override
    public Component display() {
        return getEntityNameWithInline().copy().withStyle(ChatFormatting.AQUA);
    }

    private Component getEntityNameWithInline() {
...
//            return Component.literal(nameJson);
            return Component.Serializer.fromJsonLenient(nameJson, RegistryAccess.EMPTY).withStyle(ChatFormatting.AQUA);
        }
