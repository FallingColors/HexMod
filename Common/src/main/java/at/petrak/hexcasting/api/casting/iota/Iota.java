...
public abstract class Iota {
    ...
    /**
     * This method is called to determine whether the iota is above the max serialisation
     * depth/serialisation count limits. This is an alternative to deriving subIotas for if your
     * Iota is a datastructure of variable size over something that doesn't make sense to convert to
     * an Iota iterable, such as {@link ContinuationIota}, or a typed List&lt;Double&gt;. It should
