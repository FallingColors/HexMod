...
public interface IotaHolderItem {
    /**
     * If this key is set on the item, we ignore the rest of the item and render this as if it were
     * of the {@link at.petrak.hexcasting.api.casting.iota.IotaType IotaType} given by the resource
     * location.
     *
    ...
    default int getColor(ItemStack stack) {
        if (NBTHelper.hasString(stack, TAG_OVERRIDE_VISUALLY)) {
            ...
            return 0xFF000000
                    | Mth.hsvToRgb(ClientTickCounter.getTotal() * 2 % 360 / 360F, 0.75F, 1F);
        }
