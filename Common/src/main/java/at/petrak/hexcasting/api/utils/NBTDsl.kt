...
object NBTBuilder {
    ...
    inline fun byteArray(): ByteArrayTag =
        ByteArrayTag(byteArrayOf()) // avoiding overload ambiguity
    ...
    inline fun longArray(): LongArrayTag =
        LongArrayTag(longArrayOf()) // avoiding overload ambiguity
