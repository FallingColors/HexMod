...
public final class SpecialPatterns {
    ...
    public static final HexPattern BIG_INTRO = HexPattern.fromAngles("eqqqe", HexDir.SOUTH_WEST);
    public static final HexPattern BIG_RETRO = HexPattern.fromAngles("qeeeq", HexDir.SOUTH_EAST);
