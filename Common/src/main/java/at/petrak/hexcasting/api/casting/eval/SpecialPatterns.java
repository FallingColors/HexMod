...
public final class SpecialPatterns {
    ...
    public static final HexPattern INTROSPECTION_II = HexPattern.fromAngles("eqqqe", HexDir.SOUTH_WEST);
    public static final HexPattern RETROSPECTION_II = HexPattern.fromAngles("qeeeq", HexDir.SOUTH_EAST);
