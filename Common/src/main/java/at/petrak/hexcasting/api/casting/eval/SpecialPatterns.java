...
public final class SpecialPatterns {
    ...
    public static final HexPattern BIG_INTRO = HexPattern.fromAngles("eqqqe", HexDir.EAST);
    public static final HexPattern BIG_RETRO = HexPattern.fromAngles("qeeeq", HexDir.EAST);
