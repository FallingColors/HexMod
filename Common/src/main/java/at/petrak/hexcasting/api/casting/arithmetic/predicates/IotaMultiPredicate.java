...
public interface IotaMultiPredicate {
    ...
    /**
     * The resulting IotaMultiPredicate only returns true if all iotas passed into test match the
     * type dictated by child.
     */
     ...
     */
    static IotaMultiPredicate triple(
            IotaPredicate first, IotaPredicate second, IotaPredicate third) {
    ...
    record Either(IotaMultiPredicate first, IotaMultiPredicate second)
            implements IotaMultiPredicate {
        @Override
        public boolean test(Iterable<Iota> iotas) {
