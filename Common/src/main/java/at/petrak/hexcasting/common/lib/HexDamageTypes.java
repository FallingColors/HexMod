...
public class HexDamageTypes {
    ...
    public static final ResourceKey<DamageType> STACK_SIZE = ResourceKey.create(Registries.DAMAGE_TYPE, modLoc("stack_size"));
    ...
    public static void bootstrap(BootstapContext<DamageType> ctx) {
        ...
        ctx.register(STACK_SIZE, new DamageType(
                "hexcasting.stack_size",
                DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER,
                0f
        ));
    }
