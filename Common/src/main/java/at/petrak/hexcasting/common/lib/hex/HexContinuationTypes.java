...
public class HexContinuationTypes {
    ...
    public static final String KEY_TYPE = HexAPI.MOD_ID + ":type",
    ...
    private static <U extends ContinuationFrame, T extends ContinuationFrame.Type<U>>
            T continuation(String name, T continuation) {
