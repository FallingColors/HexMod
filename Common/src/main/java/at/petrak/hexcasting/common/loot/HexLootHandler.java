...
public class HexLootHandler {
    public static final ImmutableList<ScrollInjection> DEFAULT_SCROLL_INJECTS =
            ImmutableList.of(
                    // TODO: not sure what the lore implications of scrolls and the nether/end are.
                    // adding scrolls
                    // there for now just to be nice to players.

                    // In places where it doesn't really make sense to have them lore-wise just put
                    // them rarely anyways
                    // to make it less of a PITA for new players
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/simple_dungeon"), 1),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/abandoned_mineshaft"), 1),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/bastion_other"), 1),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/nether_bridge"), 1),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/jungle_temple"), 2),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/desert_pyramid"), 2),
                    new ScrollInjection(
                            new ResourceLocation(
                                    "minecraft", "chests/village/village_cartographer"),
                            2),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/shipwreck_map"), 3),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/bastion_treasure"), 3),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/end_city_treasure"), 3),

                    // ancient city chests have amethyst in them, thinking emoji
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/ancient_city"), 4),
                    // wonder what those pillagers are up to with those scrolls
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/pillager_outpost"), 4),

                    // if you manage to find one of these things you deserve a lot of scrolls
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/woodland_mansion"), 5),
                    new ScrollInjection(
                            new ResourceLocation("minecraft", "chests/stronghold_library"), 5));
