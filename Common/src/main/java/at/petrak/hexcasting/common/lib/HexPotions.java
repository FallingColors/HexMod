...
public class HexPotions {
    ...
    /**
     * Add Hex Casting potion brewing recipes. Called from Forge's RegisterBrewingRecipesEvent
     * (Fabric uses a different approach when that module is enabled).
     */
    public static void addRecipes(PotionBrewing.Builder builder) {
        builder.addMix(Potions.AWKWARD, HexItems.AMETHYST_DUST, Holder.direct(ENLARGE_GRID));
        builder.addMix(Holder.direct(ENLARGE_GRID), Items.REDSTONE, Holder.direct(ENLARGE_GRID_LONG));
        builder.addMix(Holder.direct(ENLARGE_GRID), Items.GLOWSTONE_DUST, Holder.direct(ENLARGE_GRID_STRONG));

        builder.addMix(Holder.direct(ENLARGE_GRID), Items.FERMENTED_SPIDER_EYE, Holder.direct(SHRINK_GRID));
        builder.addMix(Holder.direct(ENLARGE_GRID_LONG), Items.FERMENTED_SPIDER_EYE, Holder.direct(SHRINK_GRID_LONG));
        builder.addMix(Holder.direct(ENLARGE_GRID_STRONG), Items.FERMENTED_SPIDER_EYE, Holder.direct(SHRINK_GRID_STRONG));

        builder.addMix(Holder.direct(SHRINK_GRID), Items.REDSTONE, Holder.direct(SHRINK_GRID_LONG));
        builder.addMix(Holder.direct(SHRINK_GRID), Items.GLOWSTONE_DUST, Holder.direct(SHRINK_GRID_STRONG));
    }
