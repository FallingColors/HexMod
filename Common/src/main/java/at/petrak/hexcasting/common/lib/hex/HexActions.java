...
public class HexActions {
    ...
    public static final ActionRegistryEntry ENTITY_LOOK =
            make(
                    "get_entity_look",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wa", HexDir.EAST), OpEntityLook.INSTANCE));
    public static final ActionRegistryEntry ENTITY_HEIGHT =
            make(
                    "get_entity_height",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("awq", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry RAYCAST =
            make(
                    "raycast",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wqaawdd", HexDir.EAST),
                            OpBlockRaycast.INSTANCE));
    public static final ActionRegistryEntry RAYCAST_AXIS =
            make(
                    "raycast/axis",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("weddwaa", HexDir.EAST),
    ...
    public static final ActionRegistryEntry CIRCLE$IMPETUS_POST =
            make(
                    "circle/impetus_pos",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eaqwqae", HexDir.SOUTH_WEST),
                            OpImpetusPos.INSTANCE));
    public static final ActionRegistryEntry CIRCLE$IMPETUS_DIR =
            make(
                    "circle/impetus_dir",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eaqwqaewede", HexDir.SOUTH_WEST),
                            OpImpetusDir.INSTANCE));
    public static final ActionRegistryEntry CIRCLE$BOUNDS$MIN =
            make(
                    "circle/bounds/min",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eaqwqaewdd", HexDir.SOUTH_WEST),
                            new OpCircleBounds(false)));
    public static final ActionRegistryEntry CIRCLE$BOUNDS$MAX =
            make(
                    "circle/bounds/max",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aqwqawaaqa", HexDir.WEST),
                            new OpCircleBounds(true)));
    ...
    public static final ActionRegistryEntry SWAP =
            make(
                    "swap",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aawdd", HexDir.EAST),
    ...
    public static final ActionRegistryEntry DUPLICATE =
            make(
                    "duplicate",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aadaa", HexDir.EAST),
    ...
    public static final ActionRegistryEntry STACK_LEN =
            make(
                    "stack_len",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qwaeawqaeaqa", HexDir.NORTH_WEST),
    ...
    public static final ActionRegistryEntry FISHERMAN$COPY =
            make(
                    "fisherman/copy",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aada", HexDir.EAST),
    ...
    public static final ActionRegistryEntry COERCE_AXIAL =
            make(
                    "coerce_axial",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qqqqqaww", HexDir.NORTH_WEST),
    ...
    public static final ActionRegistryEntry EQUALS =
            make(
                    "equals",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("ad", HexDir.EAST), new OpEquality(false)));
    public static final ActionRegistryEntry NOT_EQUALS =
            make(
                    "not_equals",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("da", HexDir.EAST), new OpEquality(true)));
    ...
    public static final ActionRegistryEntry BOOL_COERCE =
            make(
                    "bool_coerce",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aw", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry ADD_MOTION =
            make(
                    "add_motion",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("awqqqwaqw", HexDir.SOUTH_WEST),
                            OpAddMotion.INSTANCE));
    public static final ActionRegistryEntry BLINK =
            make(
                    "blink",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("awqqqwaq", HexDir.SOUTH_WEST),
                            OpBlink.INSTANCE));
    ...
    public static final ActionRegistryEntry PLACE_BLOCK =
            make(
                    "place_block",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eeeeede", HexDir.SOUTH_WEST),
                            OpPlaceBlock.INSTANCE));
    public static final ActionRegistryEntry COLORIZE =
            make(
                    "colorize",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("awddwqawqwawq", HexDir.EAST),
                            OpColorize.INSTANCE));
    public static final ActionRegistryEntry CYCLE_VARIANT =
            make(
                    "cycle_variant",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("dwaawedwewdwe", HexDir.WEST),
                            OpCycleVariant.INSTANCE));
    ...
    public static final ActionRegistryEntry RECHARGE =
            make(
                    "recharge",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qqqqqwaeaeaeaeaea", HexDir.NORTH_WEST),
                            OpRecharge.INSTANCE));
    ...
    public static final ActionRegistryEntry EDIFY =
            make(
                    "edify",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wqaqwd", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry BEEP =
            make(
                    "beep",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("adaa", HexDir.WEST), OpBeep.INSTANCE));
            ...
            make(
                    ...
                    new ActionRegistryEntry(
                            HexPattern.fromAngles(
                                    "wwaqqqqqeawqwqwqwqwqwwqqeadaeqqeqqeadaeqq", HexDir.EAST),
                            new OpMakePackagedSpell<>(
                                    HexItems.ARTIFACT, 10 * MediaConstants.CRYSTAL_UNIT)));
    public static final ActionRegistryEntry CRAFT$BATTERY =
            make(
                    "craft/battery",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles(
                                    "aqqqaqwwaqqqqqeqaqqqawwqwqwqwqwqw", HexDir.SOUTH_WEST),
    ...
    public static final ActionRegistryEntry POTION$WITHER =
            make(
                    ...
                    new ActionRegistryEntry(
                            ...
                            new OpPotionEffect(
                                    MobEffects.WITHER, MediaConstants.DUST_UNIT, true, false)));
    public static final ActionRegistryEntry POTION$POISON =
            make(
                    ...
                    new ActionRegistryEntry(
                            ...
                            new OpPotionEffect(
                                    MobEffects.POISON, MediaConstants.DUST_UNIT / 3, true, false)));
    ...
    public static final ActionRegistryEntry POTION$ABSORPTION =
            make(
                    ...
                    new ActionRegistryEntry(
                            ...
                            new OpPotionEffect(
                                    MobEffects.ABSORPTION, MediaConstants.DUST_UNIT, true, true)));
    ...
    public static final ActionRegistryEntry FLIGHT$CAN_FLY =
            make(
                    "flight/can_fly",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("dwdwdeweaqa", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry LIGHTNING =
            make(
                    "lightning",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("waadwawdaaweewq", HexDir.EAST),
                            OpLightning.INSTANCE));

    public static final ActionRegistryEntry ALTIORA =
            make(
                    "flight",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eawwaeawawaa", HexDir.NORTH_WEST),
                            OpAltiora.INSTANCE));
    ...
    public static final ActionRegistryEntry SENTINEL$GREAT =
            make(
                    ...
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("waeawaeqqqwqwqqwq", HexDir.EAST),
                            new OpCreateSentinel(true)));
    public static final ActionRegistryEntry DISPEL_RAIN =
            make(
                    "dispel_rain",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eeewwweeewwaqqddqdqd", HexDir.EAST),
                            new OpWeather(false)));
    public static final ActionRegistryEntry SUMMON_RAIN =
            make(
                    "summon_rain",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wwweeewwweewdawdwad", HexDir.WEST),
                            new OpWeather(true)));
    public static final ActionRegistryEntry BRAINSWEEP =
            make(
                    ...
                    new ActionRegistryEntry(
                            HexPattern.fromAngles(
                                    "qeqwqwqwqwqeqaeqeaqeqaeqaqded", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry AKASHIC$READ =
            make(
                    "akashic/read",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qqqwqqqqqaq", HexDir.WEST),
                            OpAkashicRead.INSTANCE));
    public static final ActionRegistryEntry AKASHIC$WRITE =
            make(
                    "akashic/write",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eeeweeeeede", HexDir.EAST),
    ...
    public static final ActionRegistryEntry EVAL$CC =
            make(
                    "eval/cc",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qwaqde", HexDir.NORTH_WEST),
    ...
    public static final ActionRegistryEntry READ =
            make(
                    "read",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aqqqqq", HexDir.EAST), OpRead.INSTANCE));
    public static final ActionRegistryEntry READ$ENTITY =
            make(
                    "read/entity",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wawqwqwqwqwqw", HexDir.EAST),
                            OpTheCoolerRead.INSTANCE));
    public static final ActionRegistryEntry WRITE =
            make(
                    "write",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("deeeee", HexDir.EAST), OpWrite.INSTANCE));
    public static final ActionRegistryEntry WRITE$ENTITY =
            make(
                    "write/entity",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wdwewewewewew", HexDir.EAST),
                            OpTheCoolerWrite.INSTANCE));
    ...
    public static final ActionRegistryEntry READABLE$ENTITY =
            make(
                    "readable/entity",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wawqwqwqwqwqwew", HexDir.EAST),
                            OpTheCoolerReadable.INSTANCE));
    ...
    public static final ActionRegistryEntry WRITABLE$ENTITY =
            make(
                    "writable/entity",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("wdwewewewewewqw", HexDir.EAST),
                            OpTheCoolerWritable.INSTANCE));

    public static final ActionRegistryEntry READ$LOCAL =
            make(
                    "read/local",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qeewdweddw", HexDir.NORTH_EAST),
                            OpPeekLocal.INSTANCE));
    public static final ActionRegistryEntry WRITE$LOCAL =
            make(
                    "write/local",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("eqqwawqaaw", HexDir.NORTH_WEST),
                            OpPushLocal.INSTANCE));
    ...
    public static final ActionRegistryEntry GET_ENTITY =
            make(
                    "get_entity",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qqqqqdaqa", HexDir.SOUTH_EAST),
    ...
    public static final ActionRegistryEntry EMPTY_LIST =
            make(
                    "empty_list",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("qqaeaae", HexDir.NORTH_EAST),
    ...
    public static final ActionRegistryEntry LAST_N_LIST =
            make(
                    "last_n_list",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("ewdqdwe", HexDir.SOUTH_WEST),
    ...
    static {
        if (PehkuiInterop.isActive()) {
            make(
                    "interop/pehkui/get",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("aawawwawwa", HexDir.NORTH_WEST),
                            OpGetScale.INSTANCE));
            make(
                    "interop/pehkui/set",
                    new ActionRegistryEntry(
                            HexPattern.fromAngles("ddwdwwdwwd", HexDir.NORTH_EAST),
                            OpSetScale.INSTANCE));
        }
    }
