...
object OpBlockRaycast : ConstMediaAction {
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
        ...
        return if (blockHitResult.type == HitResult.Type.BLOCK &&
            ...
            // the position on the bhr is the position of the specific *hit point*, which is
            // actually on the outside of the block
            // this is weird (for example, casting OpBreakBlock at this position will not break the
