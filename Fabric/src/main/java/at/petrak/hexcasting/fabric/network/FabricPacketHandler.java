...
public class FabricPacketHandler {
    public static void init() {
        ServerPlayNetworking.registerGlobalReceiver(
                ...
                makeServerBoundHandler(
                        MsgNewSpellPatternC2S::deserialize, MsgNewSpellPatternC2S::handle));
        ServerPlayNetworking.registerGlobalReceiver(
    ...
    public static void initClient() {
        ClientPlayNetworking.registerGlobalReceiver(
                ...
                makeClientBoundHandler(
                        MsgNewSpellPatternS2C::deserialize, MsgNewSpellPatternS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
                MsgBlinkS2C.ID,
                makeClientBoundHandler(MsgBlinkS2C::deserialize, MsgBlinkS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
                MsgCastParticleS2C.ID,
                makeClientBoundHandler(
                        MsgCastParticleS2C::deserialize, MsgCastParticleS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
                MsgOpenSpellGuiS2C.ID,
                makeClientBoundHandler(
                        MsgOpenSpellGuiS2C::deserialize, MsgOpenSpellGuiS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
                MsgBeepS2C.ID, makeClientBoundHandler(MsgBeepS2C::deserialize, MsgBeepS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
                MsgNewWallScrollS2C.ID,
                makeClientBoundHandler(
                        MsgNewWallScrollS2C::deserialize, MsgNewWallScrollS2C::handle));
        ClientPlayNetworking.registerGlobalReceiver(
