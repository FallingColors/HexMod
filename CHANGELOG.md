...
- Added Neural Mesh, a multipart block which can be attached to Budding Amethyst to make it grow faster ([#1296](https://github.com/FallingColors/HexMod/pull/1292)) @Robotgiggle
